CREATE TABLE api2_application_information (
	...
	is_write_user_actions BOOLEAN DEFAULT '0' NOT NULL,
	is_write_calendar BOOLEAN DEFAULT '0' NOT NULL,
	is_callback_url BOOLEAN DEFAULT '1' NOT NULL,
	is_callback_display BOOLEAN DEFAULT '1' NOT NULL,
	is_callback_javascript BOOLEAN DEFAULT '1' NOT NULL,
	allowed_callback_urls TEXT NULL,
	is_auto_approve BOOLEAN DEFAULT '0' NOT NULL,
	is_all_sites BOOLEAN DEFAULT '1' NOT NULL,
