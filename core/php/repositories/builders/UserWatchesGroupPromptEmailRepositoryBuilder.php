...
use models\UserWatchesGroupPromptEmailModel;
 ...
 */
class UserWatchesGroupPromptEmailRepositoryBuilder  extends BaseRepositoryBuilder {
	...
	protected function build() {
		...
		$this->joins[] = " LEFT JOIN group_information ON group_information.id = user_watches_group_prompt_email.group_id ";
		$this->selects[] = ' user_watches_group_prompt_email.* ';
		...
		if ($this->user) {
			$this->where[] = " user_watches_group_prompt_email.user_account_id = :user_account_id";
	...
	public function fetchAll() {
		...
		while($data = $this->stat->fetch()) {
			$email = new UserWatchesGroupPromptEmailModel();
