...
class API2ApplicationRepository {
	...
	public function edit(API2ApplicationModel $app, UserAccountModel $user=null) {
		...
		$stat = $DB->prepare("UPDATE api2_application_information SET ".
				...
				"is_write_user_profile = :is_write_user_profile,is_write_calendar = :is_write_calendar,is_callback_url = :is_callback_url,".
		...
		$stat->execute(array(
				...
				'is_write_user_profile'=>$app->getIsWriteUserProfile()?1:0,
