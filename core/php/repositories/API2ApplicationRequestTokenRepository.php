...
class API2ApplicationRequestTokenRepository {
	...
	public function create(API2ApplicationModel $app, API2ApplicationRequestTokenModel $requestToken) {
		...
		$stat = $this->app['db']->prepare("INSERT INTO api2_application_request_token (api2_application_id, request_token, created_at, user_id, ".
	...
	public function loadByAppAndRequestToken(API2ApplicationModel $app, $requestToken) {
		$stat = $this->app['db']->prepare("SELECT api2_application_request_token.* FROM api2_application_request_token".
