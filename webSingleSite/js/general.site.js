...
function showExportPopup() {
	...
	if (div.size() == 0) {
		...
		html +=	'<div id="ExportPopupClose" class="PopupBoxClose"><a href="#" onclick="closePopup(); return false;" title="Close"><img src="/img/actionClosePopup.png" alt="Close"></a></div>';
		...
		html += ' <li class="ical" id="ExportToAppleCalendarTab"><span class="wrapper"><a href="#" onclick="exportPopupTabClick(\'ExportToAppleCalendar\'); return false;"><img src="/img/apple.png" alt="Apple">iCal/iPhone/iPad</a></span></li>';
...
function showSharePopup() {
	...
	if (div.size() == 0) {
		...
		html +=	'<div id="SharePopupClose" class="PopupBoxClose"><a href="#" onclick="closePopup(); return false;" title="Close"><img src="/img/actionClosePopup.png" alt="Close"></a></div>';
		
		html += '<ul class="SharePopupOptions">'
		
		html += '<li><a href="https://twitter.com/intent/tweet?text='+encodeURIComponent(url+" "+text+( config.twitter ? " via @"+config.twitter : ""))+'" target="_blank" title="Twitter"><img src="/img/logoTwitter.png" alt="Twitter"></a></li>';
		html += '<li><a href="https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(url)+'" target="_blank" title="Facebook"><img src="/img/logoFacebook.png" alt="Facebook"></a></li>';
		html += '<li><a href="https://plus.google.com/share?url='+encodeURIComponent(url)+'" target="_blank" title="Google Plus"><img src="/img/logoGooglePlus.png" alt="Google Plus"></a></li>';
